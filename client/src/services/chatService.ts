...
//   sendDirectMessage: (userId: number, content: string) => Promise<DirectMessage>;
...
//   },
  ...
  // async sendDirectMessage(id: number, content: string, data: SendMessageRequest): Promise<DirectMessage> {
